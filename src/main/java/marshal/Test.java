...
//        String read = "<?xml version='1.0' encoding='UTF-8'?><tsResponse><credentials token=\"dsffsfsds\"><site id=\"sitId\"/><user id=\"userId\"/></credentials></tsResponse>";
//        String read = "<tsResponse><credentials token=\"dsffsfsds\"><site id=\"sitId\"/><user id=\"userId\"/></credentials></tsResponse>";
//        TsResponse tsResponse = new TsResponse();
//        TsResponse tsResponse1 = xmlToBean(read, tsResponse);


        String read = "<tsResponse><credentials token=\"dsffsfsds\"><site id=\"sitId\"/><user id=\"userId\"/></credentials></tsResponse>";
        String read1 = "<tsResponse xmlns=\"http://tableau.com/api\" xmlns:xsi=\"http:www.w3.org/2011/XMLSchema-instance\"><credentials token=\"dsffsfsds\"><site id=\"sitId\"/><user id=\"userId\"/></credentials></tsResponse>";
        TsResponse tsResponse = new TsResponse();
        TsResponse tsResponse1 = JAXBUtil.unmarshal(read1, tsResponse.getClass());
        System.out.println(tsResponse1);
    }
}